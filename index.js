...
function get20s(arrTwo){
  let artistTwenty = [];
  arrTwo.yearsTwo = [];
  for(let i = 0; i < arrTwo.length; i++){
    arrTwo[i].years = arrTwo[i].years.split(" ");
    arrTwo[i].yearsTwo = arrTwo[i].years.splice(2,1) 
    arrTwo[i].years = arrTwo[i].years.splice(0,1);
    
    if(arrTwo[i].years >= 1900 && arrTwo[i].years <= 2000){
      artistTwenty.push(arrTwo[i].name);
    }else if(arrTwo[i].yearsTwo >= 1900 && arrTwo[i].yearsTwo <=2000){
      artistTwenty.push(arrTwo[i].name);
    }
  }
...
*/
function removeArtist(arrThree, index) {
...
function addArtist(arrFour, id, name, years, genre, nationality, bio){
    arrFour.push({id, name, years, genre, nationality, bio});
    return arrFour;
  }

console.log(addArtist(artists, 21, "Zachary", "1993-2020", "Web Design", "American", "This is a bio. This is a bio."));
...
function lotsOfArt(arrFive){

  let lotsOfPaint = [];
  for(let i = 0; i < arrFive.length; i++){
    if(arrFive[i].paintings > 100){
      lotsOfPaint.push(arrFive[i].name);
    }
  }
  return lotsOfPaint;
...
function randomize(arrSix){

  arrSix.sort(() => Math.random() - 0.5);
  return arrSix;
